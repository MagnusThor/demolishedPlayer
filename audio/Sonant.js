var SonantPLayer = (function () {
    function SonantPLayer(song) {
        this.song = song;
        this.WAVE_SPS = 44100;
        this.WAVE_CHAN = 2;
    ...
    SonantPLayer.prototype.play = function () {
    };
    SonantPLayer.prototype.createAudio = function (settings) {
        var _this = this;
    ...
    SonantPLayer.prototype.osc_sin = function (value) {
        return Math.sin(value * 6.283184);
    };
    SonantPLayer.prototype.osc_square = function (value) {
        if (this.osc_sin(value) < 0)
            return -1;
        return 1;
    };
    SonantPLayer.prototype.osc_saw = function (value) {
        return (value % 1) - 0.5;
    };
    SonantPLayer.prototype.osc_tri = function (value) {
        var v2 = (value % 1) * 4;
        if (v2 < 2)
            return v2 - 1;
        return 3 - v2;
    };
    SonantPLayer.prototype.getnotefreq = function (n) {
        return 0.00390625 * Math.pow(1.059463094, n - 128);
    };
    SonantPLayer.prototype.getData = function (t, n) {
